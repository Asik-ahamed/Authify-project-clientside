...
const Header = () => {
  ...
  return (
   <div className="text-center d-flex flex-column align-items-center justify-content py-5 px-3" style={{minHeight: "80vh"}}>
       <img src={assets.header} alt="header" width={150} className='mb-4' />
