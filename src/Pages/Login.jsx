    ...
    <div className="position-relative min-vh-100 d-flex justify-content-center align-items-center" style={{background: "linear-gradient(90deg, #6a5af9, #8268f9)", border:"none"}}>
       <div style={{position:"absolute", top:"20px", left:"30px", display:"flex", alignItems:"center"}}>
           <Link to="/" style={{
            ...
            <img src={assets.logo_home} alt="logo" height={50} width={50} />
           ...
           <div className="text-center mt-3">
            <p className='mb-0'>
              ...
              <>
                 ...
                 <span className='text-decoration-underline' style={{cursor:"pointer"}} onClick={() => setIsCreateAccount(false)}>
                   Login here
                 </span>
              </>
            ): (
              <>
                  ...
                  <span className='text-decoration-underline' style={{cursor:'pointer'}} onClick={() => setIsCreateAccount(true)} >
                    Sign Up
                  </span>
              </>
            )
